...
export class AdminUsersComponent implements OnInit {
        ...
        if (response && response.data) {
          ...
          this.userList = _.map(response.data.rows, item => {
            ...
            let obj = {
              ...
              userFirstName: item.schoolDetails.first_name,
              userLastName: item.schoolDetails.last_name,
              userId: item.schoolDetails.user_id,
              email: item.email,
  ...
  editUser(item: any): void {
    this.router.navigate(['/school/add-user'], { queryParams: { id: item.userId } });
  }

  importUser(): void {
    this.router.navigate(['/school/import-user'], { queryParams: { type: 'Users' } });
  }
